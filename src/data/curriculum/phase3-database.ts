...
export const phase3Database: CurriculumTask[] = [
  ...
  { topic: 'Week 21 Review', description: 'SQL fundamentals review with practice', taskType: 'revise', estimatedMinutes: 120, outcome: 'SQL basics solid' },

  // Week 22: Joins & Advanced Queries
  ...
  { topic: 'Week 22 Review', description: 'Joins and advanced queries review', taskType: 'revise', estimatedMinutes: 120, outcome: 'Query writing confident' },

  // Week 23: Database Design
  ...
  { topic: 'Week 23 Review', description: 'Database design review', taskType: 'revise', estimatedMinutes: 120, outcome: 'Design skills solid' },
  ...
  { topic: 'Week 24 Review', description: 'DML and DDL review', taskType: 'revise', estimatedMinutes: 120, outcome: 'Database manipulation confident' },
  ...
  { topic: 'Week 25 Review', description: 'JDBC comprehensive review', taskType: 'revise', estimatedMinutes: 120, outcome: 'JDBC skills solid' },

  // Week 26: Database Project & Review
